  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <form name='update' action='email_settings.php' method='post'>
        ...
        <label>Root URL of your HMS install including http or https protocol (VERY Important) <br/><div class="text-muted"> <?="Default location would be: ".$urlProtocol.$_SERVER['HTTP_HOST'].$us_url_root?></div></label>
