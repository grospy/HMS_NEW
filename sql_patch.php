...
//
// This may be run after an upgraded HMS has been installed.
// Its purpose is to upgrade the MySQL HMS database as needed
// for the new release.
...
<html>
<head>
<title>HMS <?php echo attr($EMRversion) ?> <?php echo xlt('Database Patch'); ?></title>
...
<div style="box-shadow: 3px 3px 5px 6px #ccc; border-radius: 20px; padding: 10px 40px;background-color:#EFEFEF; width:500px; margin:40px auto">
  ...
  <p style="font-weight:bold; font-size:1.8em; text-align:center">HMS <?php echo text($EMRversion),' ',xlt('Database Patch'),' ',text($desiredVersion->getRealPatch()) ?></p>
