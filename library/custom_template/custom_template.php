                ...
                <a href="#" id="enter" onclick="top.restoreSession();ascii_write('13','textarea1');" title="<?php echo htmlspecialchars(xl('Enter Key'), ENT_QUOTES);?>"><img border=0 src="../../images/enter.gif"></a>&nbsp;
                        ...
                        <tr>
                            <td valign=top style="width:180px;">
                                ...
                                <a href="personalize.php?list_id=<?php echo $rowContext['cl_list_id'];?>" id="personalize_link" class="iframe_medium css_button_small"><span><?php echo htmlspecialchars(xl('Personalize'), ENT_QUOTES);?></span></a>
                                <a href="add_custombutton.php" id="custombutton" class="iframe_medium css_button_small" title="<?php echo htmlspecialchars(xl('Add Buttons for Special Chars,Texts to be Displayed on Top of the Editor for inclusion to the text on a Click'), ENT_QUOTES);?>"><span><?php echo htmlspecialchars(xl('Add Buttons'), ENT_QUOTES);?></span></a>
                            </td>
